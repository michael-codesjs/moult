...
export type USER_CREDENTIALS_DELETE_DOMAIN_EVENT = DomainEvent<string, "USER_CREDENTIALS_UPDATED", {}>;

export type USER_CREDENTIALS_DOMAIN_EVENTS = USER_CREDENTIALS_CREATED_DOMAIN_EVENT | USER_CREDENTIALS_UPDATED_DOMAIN_EVENT