...
const serverlessConfiguration: AWS.Service = {
  ...
  provider: {
    ...
    environment: {
      USERNAME_COUNTS_TABLE: "${ssm:/moult/${self:custom.stage}/domain/user/username-counts/table/name}",
      USERNAME_ASSIGNMENTS_TABLE: "${ssm:/moult/${self:custom.stage}/domain/user/username-assignments/table/name}",
      EVENT_BUS_NAME: "${ssm:/moult/${self:custom.stage}/infrastructure/io/event-bus/name}"
    }
  },
