...
const deployInfrastructure = async () => {    
    ...
    const spinner = ora(`Deploying username management service infrastructure to ${chalk.black(stage)}.`)
    spinner.start();
...
const deployApplication = async () => {    
    ...
    const spinner = ora(`Deploying user management service application to ${chalk.black(stage)}.`)
    spinner.start();
