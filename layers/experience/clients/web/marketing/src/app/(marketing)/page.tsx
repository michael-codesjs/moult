...
export default async function Home() {
  return (
    <div className="relative text-white">
      ...
      <section className="min-h-screen pt-16 mb:pt-20 pb-24 px-6 sm:px-6 lg:px-8">
          ...
          <div className="bg-gradient-to-r from-purple-900/50 to-indigo-900/50 rounded-3xl p-10 md:p-16 border border-white/10 overflow-hidden relative">
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/partner" className="inline-block px-6 py-3 rounded-full bg-white text-purple-900 font-medium hover:bg-gray-100 transition duration-300">
                  Partner with us
                </Link>
                <Link href="/learn-more" className="inline-block px-6 py-3 rounded-full bg-transparent border border-white/50 text-white font-medium hover:bg-white/10 transition duration-300">
                  Learn more
                </Link>
              </div>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><Link href="#" className="text-gray-300 hover:text-white">3D Gallery</Link></li>
                <li><Link href="#" className="text-gray-300 hover:text-white">AR Try-On</Link></li>
                <li><Link href="#" className="text-gray-300 hover:text-white">AI Styling</Link></li>
              </ul>
            </div>
            <div>
