...
type SendUserWithUsernameAttributeExistsParams = {
  phoneNumber: string
  email: string
}
...
export class UserDomainCommandsRepositroy {
  ...
  async sendUserWithUsernameAttributeExistsCommand(
    params: SendUserWithUsernameAttributeExistsParams,
  ) {
    return await this.adapter.sendCheckIfUserWithUsernameAttributeExistsCommand(
      params,
    )
  }
}
