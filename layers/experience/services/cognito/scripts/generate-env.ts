...
const VARIABLES = Object.freeze({
  ...
  COGNITO_USER_POOL_ID: "/moult/dev/infrastructure/authentication/user-pool/id",
  COGNITO_CLIENT_ID: "/moult/dev/infrastructure/authentication/user-pool/client/main/id",
});
